...
MAX_FIXTURES_PER_REQUEST = 100  # zvýšeno — vezmi víc zápasů!
...
class APIFootballProvider(SportsDataProvider):
    ...
    def get_upcoming_matches(self, sport: Sport, days_ahead: int,
        ...
        for day_str in dates:
            ...
            # Budoucí dny — filtruj jen NS (nezačalo)
            if day_str > today_str:
                day_fixtures = [f for f in day_fixtures if f.get("fixture", {}).get("status", {}).get("short", "NS") == "NS"]
            else:
