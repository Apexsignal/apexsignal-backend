...
MIN_SELECTION_PROBABILITY = 0.67  # optimální práh — víc vyhraných
MIN_SELECTION_PROBABILITY_AGGR = 0.67  # stejný pro všechny delší tikety
...
class TicketGenerator:
    ...
    def generate(
        ...
        FALLBACK_THRESHOLDS = [min_prob, 0.60, 0.55]
        pool = []
