...
TICKET_RANGES = {
    ...
    "stredni": (2.5, 6.0),     # Střední — kurz 2.5–6 (uvolněno z 3.0, UI dál ukazuje "3–6")
...
class TicketGenerator:
    ...
    def generate(
        ...
        FALLBACK_THRESHOLDS = sorted({min_prob, 0.65, 0.60, 0.55}, reverse=True)
        ticket = None
    ...
    MIN_ODDS_HARD = {
        ...
        "stredni": 2.5,  # STŘEDNÍ: min 2.5 (uvolněno z 3.0, dolní limit 2.5-6.0)
    ...
    MAX_EDGE_RETRIES = 8    # kolikrát appka zkusí kombinaci bez nejslabšího výběru (uvolněno z 5, viz níže)
