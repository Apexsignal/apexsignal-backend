...
# appčin vlastní kanál. Provize appka VRÁTILA zpátky na 30 % u týdne/
# 2 týdnů a 50 % jen u měsíce (2026-09-23) — dřív appka krátce (2026-08-26
# až 2026-09-23) měla jednotných 50 % napříč, uživatel to teď otočil zpět
# na stejné odstupňování, jaké appka odjakživa má u běžného doporučovacího
# programu (REFERRAL_MEMBERSHIP_COMMISSION_PCT výš).
# =====================================================================
