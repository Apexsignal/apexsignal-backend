...
def _enrich_one_fixture(provider, raw: dict, standings_cache: dict, standings_lock) -> Optional[MatchInput]:
    ...
    # standings_cache appka sdílí mezi vlákny — zámek (lock) jen kolem
    # samotného čtení/zápisu cache, ne kolem síťového volání, ať appka
    # neserializuje výkon, co se snaží paralelizací právě získat.
