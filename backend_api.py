...
# Když server startuje, spusť auto-settle v background každou hodinu
async def background_auto_settle():
    """Background task - spouští auto-settle každou hodinu"""
    await asyncio.sleep(60)  # Počkej 1 minutu po startu
    while True:
        try:
            await auto_settle_tickets()
        except Exception as e:
        ...
        await asyncio.sleep(3600)  # Čekej 1 hodinu
