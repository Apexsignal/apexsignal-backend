...
def review_candidates(candidates: list[SelectionCandidate]) -> list[SelectionCandidate]:
    ...
    prompt = (
        ...
        "seznam statisticky vyfiltrovaných výběrů (každý má podle našeho "
        "modelu pravděpodobnost nad 70 %). Pro každý vyhledej na webu ČERSTVÉ "
        "zprávy (poslední dny) o klíčových zraněních, distancích, rotaci "
        "sestavy nebo jiné události, která by tu pravděpodobnost mohla "
        "zpochybnit. Pokud nic takového nenajdeš, výběr potvrď.\n\n"
        f"{listing}\n\n"
