...
class MomentumFilter:
    ...
    def _evaluate_entry_signal(self) -> Optional[MomentumSignal]:
        ...
        if not is_real_pressure or pressure < self.MIN_PRESSURE_INDEX_FOR_SIGNAL:
            return None
        ...
        return MomentumSignal(
            ...
            market="Next Goal" if team_side == "home" else "Next Goal",
            odds=0.0,  # doplní se z externí odds API před uložením/odeslání
            reasoning=reasoning,
